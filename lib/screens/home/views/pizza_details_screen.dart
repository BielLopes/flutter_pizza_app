...
class PizzaDetailsScreen extends StatelessWidget {
  ...
  const PizzaDetailsScreen(this.pizza, {super.key});
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage('assets/${pizza.picture}'),
                ),
              ),
            ),
                        ...
                        Expanded(
                          ...
                          child: Align(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    'R\$${(pizza.price * ((100.0 - pizza.discount) / 100.0)).toStringAsFixed(2)}',
                                    style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold,
                                      color:
                                  ...
                                  Text(
                                    'R\$${pizza.price.toStringAsFixed(2)}',
                                    style: const TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.grey,
